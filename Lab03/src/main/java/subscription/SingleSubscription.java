...
/*Esta clse abstrae el contenido de una sola suscripcion 
que ocurre en lista de suscripciones que figuran en el archivo de suscrpcion(json)*/
public class SingleSubscription {
    ...
    public SingleSubscription(String url, ArrayList<String> urlParams, String urlType) {
        super();
        this.url = url;
